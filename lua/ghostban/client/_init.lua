...
net.Receive("ghost_ban_net",function()
	...
	elseif mode == 3 then
		...
		GhostBan.Language = settings[17]
		GhostBan.replaceDefBan = settings[18]
		GhostBan.CanTool = settings[19]
		GhostBan.freezeGhost = settings[20]
		GhostBan.jailMode = settings[21]
		GhostBan.canChangeJob = settings[22]
		GhostBan.CantSeeMe = settings[23]
		GhostBan.material = settings[24]
		GhostBan.percentKick = settings[25]
		--GhostBan.SuperHot = settings[26]
